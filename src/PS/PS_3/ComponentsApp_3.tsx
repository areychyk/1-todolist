...
import { v1 } from 'uuid';
import {ComponentsTodoList_3} from "./ComponentsTodoList_3";
...
// Давайте завернем нашу кучу фильтров в функцию.
...
// Давайте заменим наши if`ы на switch.

export type FilterValuesType = "all" | "active" | "completed";

function ComponentsApp_3 () {
    ...
    return (
        <div className="App">
            <ComponentsTodoList_3 title="What to learn"
                      tasks={tasksFilterForTodolist()}
...
export default ComponentsApp_3;
