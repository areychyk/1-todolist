...
export const taskAPI = {
    ...
    getTasks(todolistId: string) {
        return instance.get<TodolistResponseType<{item:  TasksType}>>(`todo-lists/${todolistId}/tasks`)
    },
    createTask(todolistId:string, title: string) {
        return  instance.post<TodolistResponseType<{item:  TasksType}>>(`todo-lists/${todolistId}/tasks`, { title: title })
    },
    updateTask(todolistId: string, taskId: string,title: string) {

        return  instance.put<TodolistResponseType<{item:  TasksType}>>(`todo-lists/${todolistId}/tasks/${taskId}`, { title: title })
    },
    deleteTask(todolistId: string, taskId: string) {

        return  instance.delete<TodolistResponseType<{item:  TasksType}>>(`todo-lists/${todolistId}/tasks/${taskId}`)
    },
